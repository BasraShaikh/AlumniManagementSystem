...
public class AlumniJobDetails {
	...
	/*
	 * public AlumniJobDetails(Integer alumniJobId, User iD, String companyName,
	 * String designation, LocalDate joinDate, LocalDate leavingDate) { super();
	 * this.alumniJobId = alumniJobId; ID = iD; this.companyName = companyName;
	 * this.designation = designation; this.joinDate = joinDate; this.leavingDate =
	 * leavingDate; }
	 */
